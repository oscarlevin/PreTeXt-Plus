...
- You may not use the Service if prohibited by applicable law, including applicable sanctions or export-control restrictions.
...
We may modify, suspend, or discontinue all or part of the Service, including free features, beta features, and integrations. Where required by law, we will provide notice.
...
### 4.2 License to PreTeXt.Plus

You grant us a worldwide, non-exclusive, royalty-free license to host, store, reproduce, process, transmit, display, and create derivative technical transformations of User Content solely as necessary to:

- Provide, operate, maintain, and secure the Service
- Generate compiled outputs and previews
- Provide support and troubleshoot service issues
- Prevent abuse and enforce these Terms

### 4.3 Public sharing

If you publish or share content through public links, you understand that such content may be accessible to anyone with the link and may be copied, modified, and redistributed by others.

### 4.4 Your responsibilities

You represent and warrant that:

- You have all rights needed to submit, process, and share User Content.
- Your User Content and use of the Service do not violate law or third-party rights.

## 5. Organization and Managed Access

If your account is provided or managed by an institution, employer, or other organization:

- That organization may have administrative rights over your account and relevant workspace content.
- Organization administrators may access, manage, reassign, or remove content associated with organization-managed workspaces, subject to their policies and applicable law.
- As between you and the organization, ownership and control of organization-managed content may be governed by separate agreements or policies.

## 6. Acceptable Use

You must not:

- Violate any applicable law, regulation, sanctions rule, or court order
...
- Reverse engineer or attempt to extract source code except where law prohibits this restriction
...
- We may suspend or revoke beta access at any time.

## 9. Service Limits, Availability, and Backups
...
The Service may interoperate with third-party services, plugins, or integrations, including build, payment, email, identity, and storage providers.

- Your use of third-party services is governed by the third party's terms and policies.
- We are not responsible for third-party services except as required by law.
- If you enable integrations, you authorize required data transfers needed for interoperability.
...
If you provide feedback, ideas, or suggestions regarding the Service, you grant us a worldwide, perpetual, irrevocable, royalty-free right to use them for any lawful purpose without compensation to you.

## 13. Copyright Complaints

If you believe content on the Service infringes your copyright, contact legal@pretext.plus with sufficient information to investigate and respond.
...
- Your use creates legal, compliance, or security risk
- It is necessary to protect the Service, users, or third parties
- We are required by law or governmental order

### 14.3 Effect

Upon termination, your right to use the Service ends. We may delete or disable access to User Content in accordance with our data retention practices, technical backup cycles, and legal obligations.

Sections that by nature should survive termination survive, including ownership, disclaimers, limitations of liability, indemnity, and dispute provisions.
...
These Terms are governed by the laws of the State of Delaware, without regard to conflict-of-law principles. Any dispute not subject to arbitration by separate agreement must be brought exclusively in the state or federal courts located in Delaware, and each party consents to personal jurisdiction and venue in those courts.
...
## 20. Compliance with Trade Controls

You represent that you are not listed on, or owned or controlled by a party listed on, any applicable sanctions or export-control restricted-party list, and that you will not use the Service in violation of applicable export control or sanctions laws.

## 21. Changes to These Terms

We may update these Terms from time to time. If we make material changes, we will post updated Terms, revise the "Last updated" date, and provide additional notice where required by law. Your continued use of the Service after updated Terms become effective constitutes acceptance.

## 22. Miscellaneous

- Entire agreement: These Terms are the complete agreement between you and us regarding the Service unless a separate written agreement applies.
- Severability: If any provision is unenforceable, the remaining provisions remain in effect.
- No waiver: Failure to enforce a provision is not a waiver.
- Assignment: You may not assign these Terms without our consent. We may assign these Terms in connection with merger, acquisition, or sale of assets.
